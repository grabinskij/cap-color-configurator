    ...
    return (
        <div className="bg-gray-200 flex justify-center items-center leading-6">
            <div className="max-w-6xl w-full mx-auto px-4 text-black md:px-20 text-left">
                ...
                <h2 className="text-lg md:text-xl pb-30 font-semibold mb-6">This legal notice also applies to the following
                    social media
                    profiles:</h2>
                ...
                <h2 className="text-lg md:text-xl pb-30 font-semibold mb-6">Dieses Impressum gilt auch für folgende Social
                    Media
                    Profile:</h2>
